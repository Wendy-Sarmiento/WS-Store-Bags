              ...
              <AnimatedSection animation="fade-up">
                <div>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 mt-6 px-6 py-3 bg-[var(--color-ocean)] text-white font-semibold rounded-xl transition-all duration-300 hover:bg-[var(--color-ocean)]/90 hover:shadow-lg hover:shadow-[var(--color-ocean)]/20 hover:scale-105 active:scale-95"
                  >
